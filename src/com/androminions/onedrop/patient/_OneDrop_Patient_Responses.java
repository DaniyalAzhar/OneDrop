...
public class _OneDrop_Patient_Responses extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.patient_responses, container, false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		donorsList=(ListView)getActivity().findViewById(R.id.responsesListView);
		donorsNearBy=new ArrayList<_OneDrop_Donor_POJO>();

		adapter=new MyCustomAdapter(getActivity(),R.layout.patient_responses_row_view,donorsNearBy);
	...
	private class MyCustomAdapter extends ArrayAdapter<_OneDrop_Donor_POJO> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (this.view == null) {
				...
				this.view = vi.inflate(R.layout.patient_responses_row_view, null);

				holder = new ViewHolder();
				holder.name = (TextView)this.view.findViewById(R.id.tvResponseDonorName);
				holder.bloodGroup= (ImageView) this.view.findViewById(R.id.tvResponseDonorBloodGroup);
				holder.age = (TextView) this.view.findViewById(R.id.tvResponseDonorAge);
				holder.gender=(TextView) this.view.findViewById(R.id.tvResponseDonorGender);
				holder.location=(TextView) this.view.findViewById(R.id.tvResponseDonorLocation);
				holder.contact=(TextView) this.view.findViewById(R.id.tvResponseDonorContact);
				this.view
				.setTag(holder);
